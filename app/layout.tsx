...
export async function generateMetadata(): Promise<Metadata> {
  ...
  const description = locale === "ko"
    ? "로컬 Codex 또는 Claude Code가 평가하는 바이브코더 AI 협업 벤치마크, Passport와 HV Rating 리더보드."
    : "A local Codex or Claude Code AI collaboration benchmark, Passport, and HV Rating leaderboard for vibe coders.";
  ...
  return {
    ...
    keywords: ["vibe coder", "Codex", "Claude Code", "AI benchmark", "leaderboard", "HV Rating", "AI Witness"],
    openGraph: {
      type: "website",
